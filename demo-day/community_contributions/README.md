# Demo Day — Community Contributions

Demo Day capstone projects live here. **New here? Read the full step-by-step
...
3. Put your work in **exactly this folder**, and nowhere else:
   ...
   ```
   demo-day/community_contributions/<your-github-username>/
   ```
